...
int main(int argc, char **argv) {
	...
	printf("The minimum temperature was %f degrees Celsius\n", min);
	printf("The maximum temperature was %f degrees Celsius\n", max);
	printf("The average temperature was %f degrees Celsius\n", avg);
