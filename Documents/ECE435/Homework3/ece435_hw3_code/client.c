...
int main(int argc, char **argv) {
	...
	//checks that the appropriate amount of arguments are passed
	if (argc != 3){
		printf("Function call [hostname] [port]");
		return -1;
	}

	//first argument string passed as host name
	hostname=argv[1];
	//second argument passed as port
	port=atoi(argv[2]);
